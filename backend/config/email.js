...
<html lang="en">
	...
	<style>
		...
		.content {
			box-shadow: 0 10px 4px rgba(252, 252, 252, 0.06);
			padding: 10px 30px;
			color: white;
			min-width: 200px;
			max-width: 600px;
	...
	<body>
		<div class="header finisher-header" style="width: 100%">
			<div class="content">
				...
				<p>
					I am writing to express my interest in the Junior Frontend
					Developer position at Tuteria Limited. I have been following your
					company for some time now and am very impressed with your work in
					the education sector. I am confident that my skills and
					experience would be a valuable asset to your team.
				</p>
				<p>
					I have a Bachelor of Science in Mathematics and Computer Science
					from the University of Port Harcourt. This rigorous program
					equipped me with a solid foundation in both theoretical and
					practical aspects of computer science.
				</p>
				<p>
					I have over three years of experience as a Web Developer. I am a
					highly motivated and results-oriented individual with a strong
					work ethic. I am also a team player and I am always eager to
					learn new things. I am proficient in HTML, CSS, JavaScript, Redux
					toolkit, Tailwind CSS, and the React framework. On the back-end,
					I have worked with Node.js as a server-side language and MongoDB
					and Firebase as databases. I also have experience with email
					marketing using Node.js.
				</p>
				<p>
					I believe my technical expertise, problem-solving mindset, and
					dedication to user-centric design make me a strong fit for the
					Junior Frontend Developer position at Tuteria Limited. I am eager
					to learn from and collaborate with your team to develop
					innovative and engaging educational products for your users.
				</p>
				<p>
					I have attached my resume for your review. I am available for an
					interview at your earliest convenience. Thank you for your time
					and consideration.
				</p>
				<p>Best regards,</p>
		...
		<script type="text/javascript">
			new FinisherHeader({
				...
				colors: {
					background: "#232324",
					particles: ["#eeeeee", "#dde37e", "#e8c2e8"],
				},
				blending: "lighten",
				opacity: {
					center: 1,
